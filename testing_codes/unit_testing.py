...
def get_altitude (start_time, suit_is_flying):
    ...
    conv_sec_to_hour = elapsed_time/3600
    altitute = conv_sec_to_hour * 5
    return altitute  
...
flag = 0
x, start_time = flag_raise(flag)
print(x, start_time)

print(flying_time(start_time, x))
# get_altitude(x, start_time)
# print(get_altitude(start_time, x))
